  ...
  return (
    ...
    <div className="bg-white min-h-[12vh] py-2 px-8 flex justify-around items-center">
        <div className="rightSide text-start w-[38%]">
            <h1 onClick={()=>{contextData.setCervicalCancerData(false)}} className="Heading cursor-pointer text-2xl font-semibold px-2">Cervical Cancer</h1>
        </div>
...
export default CervicalCancerHeader;
