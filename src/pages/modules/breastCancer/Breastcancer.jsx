    ...
    <div className="container mx-auto">
      <div className="Upper flex gap-3">
        <div className="Left w-[48.5vw] flex flex-col">
          ...
          <div onClick={()=>{contextData.setBreastCancerData(!contextData.BreastCancerData)}} className="Leftupper cursor-pointer bg-[#FFFFFF] w-[14vw] min-h-[25vh] mx-2 my-1 shadow-md rounded-md px-6 flex flex-col justify-center gap-2">
            <div className="img p-2 bg-[#F6F6F6] w-fit">
              <div className="rounded-full w-fit">
                <img src={Cancer} alt="" className="size-12" /> {/* Image placeholder */}
              </div>
            </div>
          ...
          <div className="Leftlower bg-[#FFFFFF] w-[49vw] min-h-[5vh] mx-2 my-1 shadow-md rounded-md flex justify-between items-center p-2">
            <h1 className='font font-semibold px-2'>Candidate Visit</h1>
            ...
            <div onClick={handleChartDown} className="flex justify-between items-center gap-1 text-[13px] cursor-pointer">
              <button className='text-[#7a5fe6]'>{showChart ? "Hide Graph" : 'View Graph'}</button>
